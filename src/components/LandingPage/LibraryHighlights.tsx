...
const events = [
  {
    ...
    description: 'Alanında uzman konuşmacılarla bilim ve teknoloji üzerine interaktif söyleşi.',
  },
  {
  ...
  },
  {
    ...
    description: 'Kütüphanemizin dijital kaynaklarına nasıl erişilir, arşiv kullanımı eğitimi.',
  },
];
          ...
          >
            ...
            >
              ...
              <Link
                ...
                underline="hover"
                color="primary"
                sx={{ fontWeight: '700', fontSize: '0.95rem', cursor: 'pointer' }}
                onClick={() => alert(`Etkinlik detaylarına gidiliyor: ${event.title}`)}
              >
                Detaylar &rarr;
              </Link>
            </Card>
